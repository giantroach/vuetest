...
export class Vuetest implements Game {
  constructor() {
    console.log("vuetest constructor");
...
define([
  ...
  return declare("bgagame.vuetest", ebg.core.gamegui, new Vuetest());
});
